    ...
    function (l, f, p, m, v, y) {
          ...
          for (i = o.length - 1; i >= 0; i--)
            if (
              ...
              e.isDefined(c[s]) && (h || t.rerun) && (f = f.concat(c[s])),
                ...
                u(
                  h ? 'ocLazyLoad.moduleLoaded' : 'ocLazyLoad.moduleReloaded',
                  s
                ),
                o.pop(),
                d.push(s);
      ...
      (z.push = function (e) {
        ...
        (this.config = function (n) {
          e.isDefined(n.modules) &&
            (e.isArray(n.modules)
              ? e.forEach(n.modules, function (e) {
                  w[e.name] = e;
                })
        ...
        (this._init = function (o) {
          if (0 === i.length) {
            ...
            e.forEach(a, function (n) {
              (a[n] = !0),
                ...
                (n = n.replace(':', '\\:')),
                'undefined' != typeof o[0] &&
                  o[0].querySelectorAll &&
              ...
              e.forEach(t, function (n) {
                if (0 === i.length) {
                  var r = ' ' + o.className + ' ',
                    t = u.exec(r);
                  t
                    ? i.push((t[2] || '').replace(/\s+/g, ','))
                    : e.forEach(n.attributes, function (e) {
          ...
          0 !== i.length ||
            ((n.jasmine || n.mocha) && e.isDefined(e.mock)) ||
            console.error(
            ...
            }),
            {
              ...
              _getModule: function (e) {
                try {
                  ...
                  throw (
                    ((/No module/.test(n) ||
                      n.message.indexOf('$injector:nomod') > -1) &&
                      (n.message =
                        'The module "' +
                        S(e) +
              ...
              _loadDependencies: function (n, r) {
                var o,
                  ...
                  a = [],
                  s = this;
                if (((n = s._getModuleName(n)), null === n)) return l.when();
                try {
                  o = s._getModule(n);
                } catch (u) {
                  return f(u);
                  ...
                  e.forEach(t, function (o) {
                    ...
                    if (s.moduleExists(o.name))
                      return (
                        ...
                        e.isDefined(s.filesLoader)
                          ? void a.push(
                              s.filesLoader(o, r).then(function () {
              ...
              getRequires: function (n) {
                var o = [];
                return (
                  e.forEach(n.requires, function (e) {
              ...
              (n.buildElement = function (u, c, d) {
                ...
                if (d.insertBefore) {
                  var v = e.element(
                    e.isDefined(window.jQuery)
                      ? d.insertBefore
                      : document.querySelector(d.insertBefore)
                  );
                  v && v.length > 0 && (m = v[0]);
                }
                if ((m.parentNode.insertBefore(l, m), 'css' == u)) {
                  if (!i) {
                    ...
                    if (y.indexOf('phantomjs/1.9') > -1) a = !0;
                    else if (/iP(hone|od|ad)/.test(o.navigator.platform)) {
                      var L = o.navigator.appVersion.match(
                          /OS (\d+)_(\d+)_?(\d+)?/
                        ),
                        $ = parseFloat(
                          [
          ...
          function (n, r) {
            return (
              (n.filesLoader = function (o) {
                ...
                var l = function (r) {
                  var o,
                    l = null;
                  if (
                    (e.isObject(r) && ((l = r.type), (r = r.path)),
                    (c = d.get(r)),
                    e.isUndefined(c) || t.cache === !1)
                  ) {
                    if (
                      (null !== (o = /^(css|less|html|htm|js)?(?=!)/.exec(r)) &&
                        ((l = o[1]), (r = r.substr(o[1].length + 1, r.length))),
                      !l)
                    )
                      if (
                        null !==
                        (o = /[.](css|less|html|htm|js)?((\?|#).*)?$/.exec(r))
                      )
                        l = o[1];
                      else {
                        if (
                          n.jsLoader.hasOwnProperty('ocLazyLoadLoader') ||
                          !n.jsLoader.hasOwnProperty('requirejs')
                        )
                          return void n._$log.error(
                            'File type could not be determined. ' + r
                          );
                        l = 'js';
                      }
                    ('css' !== l && 'less' !== l) || -1 !== i.indexOf(r)
                      ? ('html' !== l && 'htm' !== l) || -1 !== a.indexOf(r)
                        ? 'js' === l || -1 === s.indexOf(r)
                          ? s.push(r)
                          : n._$log.error('File type is not valid. ' + r)
                        : a.push(r)
                      : i.push(r);
                  } else c && u.push(c);
                };
                if (
                  ...
                  n.cssLoader(
                    ...
                    function (r) {
                      e.isDefined(r) &&
                      n.cssLoader.hasOwnProperty('ocLazyLoadLoader')
                        ? (n._$log.error(r), f.reject(r))
                        : f.resolve();
                    },
                    t
                  ),
                ...
                if (a.length > 0) {
                  ...
                  n.templatesLoader(
                    ...
                    function (r) {
                      e.isDefined(r) &&
                      n.templatesLoader.hasOwnProperty('ocLazyLoadLoader')
                        ? (n._$log.error(r), h.reject(r))
                        : h.resolve();
                    },
                    t
                  ),
                ...
                return t.serie && t.files.length > 0
              ...
              (n.load = function (o) {
                ...
                if (
                  (e.isString(d)
                    ? ((s = a.getModuleConfig(d)), s || (s = {files: [d]}))
                    : e.isObject(d) &&
                      (s =
                        e.isDefined(d.path) && e.isDefined(d.type)
                          ? {files: [d]}
                          : a.setModuleConfig(d)),
                  null === s)
                ) {
                ...
                e.isDefined(s.template) &&
                  ...
                  e.isString(s.template)
                    ...
                    : e.isArray(s.template) && s.files.concat(s.template));
                var h = e.extend({}, l, s);
                return e.isUndefined(s.files) &&
                  e.isDefined(s.name) &&
                  n.moduleExists(s.name)
                  ? n.inject(s.name, h, !0)
                  : (n.filesLoader(s, h).then(
                      function () {
                        n.inject(null, h).then(
                          function (e) {
                            c.resolve(e);
                          },
                          function (e) {
    ...
    e.module('oc.lazyLoad').config([
      ...
      function (n) {
        n.decorator('$ocLazyLoad', [
          ...
          function (n, r, o, t) {
            return (
              (n.templatesLoader = function (i, a, s) {
                var u = [],
                  c = n._getFilesCache();
                return (
                    ...
                    u.push(i.promise),
                      t
                        ...
                        .then(function (o) {
                          ...
                          e.isString(t) &&
                            t.length > 0 &&
                            e.forEach(e.element(t), function (e) {
                              'SCRIPT' === e.nodeName &&
                                'text/ng-template' === e.type &&
                                r.put(e.id, e.innerHTML);
                            }),
